import{r as O,a as Tp,u as Xu,c as wp,g as Ip,N as Vo,B as bp,R as Ap,b as Eo}from"./vendor-EA-lzgZ-.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function t(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(s){if(s.ep)return;s.ep=!0;const i=t(s);fetch(s.href,i)}})();var Zu={exports:{}},Ri={};/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Th{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,t){this.storage[e]=t}async _get(e){const t=this.storage[e];return t===void 0?null:t}async _remove(e){delete this.storage[e]}_addListener(e,t){}_removeListener(e,t){}}Th.type="NONE";const wl=Th;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Il(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Ah(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(wh(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(xh(e))return"Blackberry";if(Sh(e))return"Webos";if(Ih(e))return"Safari";if((e.includes("chrome/")||bh(e))&&!e.includes("edge/"))return"Chrome";if(Rh(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function wh(n=tt()){return/firefox\//i.test(n)}function Ih(n=tt()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function bh(n=tt()){return/crios\//i.test(n)}function Ah(n=tt()){return/iemobile/i.test(n)}function Rh(n=tt()){return/android/i.test(n)}function xh(n=tt()){return/blackberry/i.test(n)}function Sh(n=tt()){return/webos/i.test(n)}function va(n=tt()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function Dg(n=tt()){var e;return va(n)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function Og(){return Kp()&&document.documentMode===10}function Ch(n=tt()){return va(n)||Rh(n)||Sh(n)||xh(n)||/windows phone/i.test(n)||Ah(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ph(n,e=[]){let t;switch(n){case"Browser":t=Il(tt());break;case"Worker":t=`${Il(tt())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${Un}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $h(){return typeof xt().WorkerGlobalScope<"u"&&typeof xt().importScripts=="function"}async function T_(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function w_(){var n;return((n=navigator==null?void 0:navigator.serviceWorker)===null||n===void 0?void 0:n.controller)||null}function I_(){return $h()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ia extends Ea{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return nr(e,this._buildIdpRequest())}_linkToIdToken(e,t){return nr(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return nr(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}function k_(n){return Lh(n.auth,new Ia(n),n.bypassAuthState)}function N_(n){const{auth:e,user:t}=n;return G(t,e,"internal-error"),a_(t,new Ia(n),n.bypassAuthState)}async function D_(n){const{auth:e,user:t}=n;return G(t,e,"internal-error"),o_(t,new Ia(n),n.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var un,Kh;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(I,f){function m(){}m.prototype=f.prototype,I.D=f.prototype,I.prototype=new m,I.prototype.constructor=I,I.C=function(v,T,b){for(var w=Array(arguments.length-2),te=2;te<arguments.length;te++)w[te-2]=arguments[te];return f.prototype[T].apply(v,w)}}function t(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,t),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(I,f,m){m||(m=0);var v=Array(16);if(typeof f=="string")for(var T=0;16>T;++T)v[T]=f.charCodeAt(m++)|f.charCodeAt(m++)<<8|f.charCodeAt(m++)<<16|f.charCodeAt(m++)<<24;else for(T=0;16>T;++T)v[T]=f[m++]|f[m++]<<8|f[m++]<<16|f[m++]<<24;f=I.g[0],m=I.g[1],T=I.g[2];var b=I.g[3],w=f+(b^m&(T^b))+v[0]+3614090360&4294967295;f=m+(w<<7&4294967295|w>>>25),w=b+(T^f&(m^T))+v[1]+3905402710&4294967295,b=f+(w<<12&4294967295|w>>>20),w=T+(m^b&(f^m))+v[2]+606105819&4294967295,T=b+(w<<17&4294967295|w>>>15),w=m+(f^T&(b^f))+v[3]+3250441966&4294967295,m=T+(w<<22&4294967295|w>>>10),w=f+(b^m&(T^b))+v[4]+4118548399&4294967295,f=m+(w<<7&4294967295|w>>>25),w=b+(T^f&(m^T))+v[5]+1200080426&4294967295,b=f+(w<<12&4294967295|w>>>20),w=T+(m^b&(f^m))+v[6]+2821735955&4294967295,T=b+(w<<17&4294967295|w>>>15),w=m+(f^T&(b^f))+v[7]+4249261313&4294967295,m=T+(w<<22&4294967295|w>>>10),w=f+(b^m&(T^b))+v[8]+1770035416&4294967295,f=m+(w<<7&4294967295|w>>>25),w=b+(T^f&(m^T))+v[9]+2336552879&4294967295,b=f+(w<<12&4294967295|w>>>20),w=T+(m^b&(f^m))+v[10]+4294925233&4294967295,T=b+(w<<17&4294967295|w>>>15),w=m+(f^T&(b^f))+v[11]+2304563134&4294967295,m=T+(w<<22&4294967295|w>>>10),w=f+(b^m&(T^b))+v[12]+1804603682&4294967295,f=m+(w<<7&4294967295|w>>>25),w=b+(T^f&(m^T))+v[13]+4254626195&4294967295,b=f+(w<<12&4294967295|w>>>20),w=T+(m^b&(f^m))+v[14]+2792965006&4294967295,T=b+(w<<17&4294967295|w>>>15),w=m+(f^T&(b^f))+v[15]+1236535329&4294967295,m=T+(w<<22&4294967295|w>>>10),w=f+(T^b&(m^T))+v[1]+4129170786&4294967295,f=m+(w<<5&4294967295|w>>>27),w=b+(m^T&(f^m))+v[6]+3225465664&4294967295,b=f+(w<<9&4294967295|w>>>23),w=T+(f^m&(b^f))+v[11]+643717713&4294967295,T=b+(w<<14&4294967295|w>>>18),w=m+(b^f&(T^b))+v[0]+3921069994&4294967295,m=T+(w<<20&4294967295|w>>>12),w=f+(T^b&(m^T))+v[5]+3593408605&4294967295,f=m+(w<<5&4294967295|w>>>27),w=b+(m^T&(f^m))+v[10]+38016083&4294967295,b=f+(w<<9&4294967295|w>>>23),w=T+(f^m&(b^f))+v[15]+3634488961&4294967295,T=b+(w<<14&4294967295|w>>>18),w=m+(b^f&(T^b))+v[4]+3889429448&4294967295,m=T+(w<<20&4294967295|w>>>12),w=f+(T^b&(m^T))+v[9]+568446438&4294967295,f=m+(w<<5&4294967295|w>>>27),w=b+(m^T&(f^m))+v[14]+3275163606&4294967295,b=f+(w<<9&4294967295|w>>>23),w=T+(f^m&(b^f))+v[3]+4107603335&4294967295,T=b+(w<<14&4294967295|w>>>18),w=m+(b^f&(T^b))+v[8]+1163531501&4294967295,m=T+(w<<20&4294967295|w>>>12),w=f+(T^b&(m^T))+v[13]+2850285829&4294967295,f=m+(w<<5&4294967295|w>>>27),w=b+(m^T&(f^m))+v[2]+4243563512&4294967295,b=f+(w<<9&4294967295|w>>>23),w=T+(f^m&(b^f))+v[7]+1735328473&4294967295,T=b+(w<<14&4294967295|w>>>18),w=m+(b^f&(T^b))+v[12]+2368359562&4294967295,m=T+(w<<20&4294967295|w>>>12),w=f+(m^T^b)+v[5]+4294588738&4294967295,f=m+(w<<4&4294967295|w>>>28),w=b+(f^m^T)+v[8]+2272392833&4294967295,b=f+(w<<11&4294967295|w>>>21),w=T+(b^f^m)+v[11]+1839030562&4294967295,T=b+(w<<16&4294967295|w>>>16),w=m+(T^b^f)+v[14]+4259657740&4294967295,m=T+(w<<23&4294967295|w>>>9),w=f+(m^T^b)+v[1]+2763975236&4294967295,f=m+(w<<4&4294967295|w>>>28),w=b+(f^m^T)+v[4]+1272893353&4294967295,b=f+(w<<11&4294967295|w>>>21),w=T+(b^f^m)+v[7]+4139469664&4294967295,T=b+(w<<16&4294967295|w>>>16),w=m+(T^b^f)+v[10]+3200236656&4294967295,m=T+(w<<23&4294967295|w>>>9),w=f+(m^T^b)+v[13]+681279174&4294967295,f=m+(w<<4&4294967295|w>>>28),w=b+(f^m^T)+v[0]+3936430074&4294967295,b=f+(w<<11&4294967295|w>>>21),w=T+(b^f^m)+v[3]+3572445317&4294967295,T=b+(w<<16&4294967295|w>>>16),w=m+(T^b^f)+v[6]+76029189&4294967295,m=T+(w<<23&4294967295|w>>>9),w=f+(m^T^b)+v[9]+3654602809&4294967295,f=m+(w<<4&4294967295|w>>>28),w=b+(f^m^T)+v[12]+3873151461&4294967295,b=f+(w<<11&4294967295|w>>>21),w=T+(b^f^m)+v[15]+530742520&4294967295,T=b+(w<<16&4294967295|w>>>16),w=m+(T^b^f)+v[2]+3299628645&4294967295,m=T+(w<<23&4294967295|w>>>9),w=f+(T^(m|~b))+v[0]+4096336452&4294967295,f=m+(w<<6&4294967295|w>>>26),w=b+(m^(f|~T))+v[7]+1126891415&4294967295,b=f+(w<<10&4294967295|w>>>22),w=T+(f^(b|~m))+v[14]+2878612391&4294967295,T=b+(w<<15&4294967295|w>>>17),w=m+(b^(T|~f))+v[5]+4237533241&4294967295,m=T+(w<<21&4294967295|w>>>11),w=f+(T^(m|~b))+v[12]+1700485571&4294967295,f=m+(w<<6&4294967295|w>>>26),w=b+(m^(f|~T))+v[3]+2399980690&4294967295,b=f+(w<<10&4294967295|w>>>22),w=T+(f^(b|~m))+v[10]+4293915773&4294967295,T=b+(w<<15&4294967295|w>>>17),w=m+(b^(T|~f))+v[1]+2240044497&4294967295,m=T+(w<<21&4294967295|w>>>11),w=f+(T^(m|~b))+v[8]+1873313359&4294967295,f=m+(w<<6&4294967295|w>>>26),w=b+(m^(f|~T))+v[15]+4264355552&4294967295,b=f+(w<<10&4294967295|w>>>22),w=T+(f^(b|~m))+v[6]+2734768916&4294967295,T=b+(w<<15&4294967295|w>>>17),w=m+(b^(T|~f))+v[13]+1309151649&4294967295,m=T+(w<<21&4294967295|w>>>11),w=f+(T^(m|~b))+v[4]+4149444226&4294967295,f=m+(w<<6&4294967295|w>>>26),w=b+(m^(f|~T))+v[11]+3174756917&4294967295,b=f+(w<<10&4294967295|w>>>22),w=T+(f^(b|~m))+v[2]+718787259&4294967295,T=b+(w<<15&4294967295|w>>>17),w=m+(b^(T|~f))+v[9]+3951481745&4294967295,I.g[0]=I.g[0]+f&4294967295,I.g[1]=I.g[1]+(T+(w<<21&4294967295|w>>>11))&4294967295,I.g[2]=I.g[2]+T&4294967295,I.g[3]=I.g[3]+b&4294967295}r.prototype.u=function(I,f){f===void 0&&(f=I.length);for(var m=f-this.blockSize,v=this.B,T=this.h,b=0;b<f;){if(T==0)for(;b<=m;)s(this,I,b),b+=this.blockSize;if(typeof I=="string"){for(;b<f;)if(v[T++]=I.charCodeAt(b++),T==this.blockSize){s(this,v),T=0;break}}else for(;b<f;)if(v[T++]=I[b++],T==this.blockSize){s(this,v),T=0;break}}this.h=T,this.o+=f},r.prototype.v=function(){var I=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);I[0]=128;for(var f=1;f<I.length-8;++f)I[f]=0;var m=8*this.o;for(f=I.length-8;f<I.length;++f)I[f]=m&255,m/=256;for(this.u(I),I=Array(16),f=m=0;4>f;++f)for(var v=0;32>v;v+=8)I[m++]=this.g[f]>>>v&255;return I};function i(I,f){var m=c;return Object.prototype.hasOwnProperty.call(m,I)?m[I]:m[I]=f(I)}function a(I,f){this.h=f;for(var m=[],v=!0,T=I.length-1;0<=T;T--){var b=I[T]|0;v&&b==f||(m[T]=b,v=!1)}this.g=m}var c={};function u(I){return-128<=I&&128>I?i(I,function(f){return new a([f|0],0>f?-1:0)}):new a([I|0],0>I?-1:0)}function h(I){if(isNaN(I)||!isFinite(I))return y;if(0>I)return S(h(-I));for(var f=[],m=1,v=0;I>=m;v++)f[v]=I/m|0,m*=4294967296;return new a(f,0)}function g(I,f){if(I.length==0)throw Error("number format error: empty string");if(f=f||10,2>f||36<f)throw Error("radix out of range: "+f);if(I.charAt(0)=="-")return S(g(I.substring(1),f));if(0<=I.indexOf("-"))throw Error('number format error: interior "-" character');for(var m=h(Math.pow(f,8)),v=y,T=0;T<I.length;T+=8){var b=Math.min(8,I.length-T),w=parseInt(I.substring(T,T+b),f);8>b?(b=h(Math.pow(f,b)),v=v.j(b).add(h(w))):(v=v.j(m),v=v.add(h(w)))}return v}var y=u(0),E=u(1),R=u(16777216);n=a.prototype,n.m=function(){if(A(this))return-S(this).m();for(var I=0,f=1,m=0;m<this.g.length;m++){var v=this.i(m);I+=(0<=v?v:4294967296+v)*f,f*=4294967296}return I},n.toString=function(I){if(I=I||10,2>I||36<I)throw Error("radix out of range: "+I);if(x(this))return"0";if(A(this))return"-"+S(this).toString(I);for(var f=h(Math.pow(I,6)),m=this,v="";;){var T=L(m,f).g;m=V(m,T.j(f));var b=((0<m.g.length?m.g[0]:m.h)>>>0).toString(I);if(m=T,x(m))return b+v;for(;6>b.length;)b="0"+b;v=b+v}},n.i=function(I){return 0>I?0:I<this.g.length?this.g[I]:this.h};function x(I){if(I.h!=0)return!1;for(var f=0;f<I.g.length;f++)if(I.g[f]!=0)return!1;return!0}function A(I){return I.h==-1}n.l=function(I){return I=V(this,I),A(I)?-1:x(I)?0:1};function S(I){for(var f=I.g.length,m=[],v=0;v<f;v++)m[v]=~I.g[v];return new a(m,~I.h).add(E)}n.abs=function(){return A(this)?S(this):this},n.add=function(I){for(var f=Math.max(this.g.length,I.g.length),m=[],v=0,T=0;T<=f;T++){var b=v+(this.i(T)&65535)+(I.i(T)&65535),w=(b>>>16)+(this.i(T)>>>16)+(I.i(T)>>>16);v=w>>>16,b&=65535,w&=65535,m[T]=w<<16|b}return new a(m,m[m.length-1]&-2147483648?-1:0)};function V(I,f){return I.add(S(f))}n.j=function(I){if(x(this)||x(I))return y;if(A(this))return A(I)?S(this).j(S(I)):S(S(this).j(I));if(A(I))return S(this.j(S(I)));if(0>this.l(R)&&0>I.l(R))return h(this.m()*I.m());for(var f=this.g.length+I.g.length,m=[],v=0;v<2*f;v++)m[v]=0;for(v=0;v<this.g.length;v++)for(var T=0;T<I.g.length;T++){var b=this.i(v)>>>16,w=this.i(v)&65535,te=I.i(T)>>>16,we=I.i(T)&65535;m[2*v+2*T]+=w*we,M(m,2*v+2*T),m[2*v+2*T+1]+=b*we,M(m,2*v+2*T+1),m[2*v+2*T+1]+=w*te,M(m,2*v+2*T+1),m[2*v+2*T+2]+=b*te,M(m,2*v+2*T+2)}for(v=0;v<f;v++)m[v]=m[2*v+1]<<16|m[2*v];for(v=f;v<2*f;v++)m[v]=0;return new a(m,0)};function M(I,f){for(;(I[f]&65535)!=I[f];)I[f+1]+=I[f]>>>16,I[f]&=65535,f++}function k(I,f){this.g=I,this.h=f}function L(I,f){if(x(f))throw Error("division by zero");if(x(I))return new k(y,y);if(A(I))return f=L(S(I),f),new k(S(f.g),S(f.h));if(A(f))return f=L(I,S(f)),new k(S(f.g),f.h);if(30<I.g.length){if(A(I)||A(f))throw Error("slowDivide_ only works with positive integers.");for(var m=E,v=f;0>=v.l(I);)m=q(m),v=q(v);var T=F(m,1),b=F(v,1);for(v=F(v,2),m=F(m,2);!x(v);){var w=b.add(v);0>=w.l(I)&&(T=T.add(m),b=w),v=F(v,1),m=F(m,1)}return f=V(I,T.j(f)),new k(T,f)}for(T=y;0<=I.l(f);){for(m=Math.max(1,Math.floor(I.m()/f.m())),v=Math.ceil(Math.log(m)/Math.LN2),v=48>=v?1:Math.pow(2,v-48),b=h(m),w=b.j(f);A(w)||0<w.l(I);)m-=v,b=h(m),w=b.j(f);x(b)&&(b=E),T=T.add(b),I=V(I,w)}return new k(T,I)}n.A=function(I){return L(this,I).h},n.and=function(I){for(var f=Math.max(this.g.length,I.g.length),m=[],v=0;v<f;v++)m[v]=this.i(v)&I.i(v);return new a(m,this.h&I.h)},n.or=function(I){for(var f=Math.max(this.g.length,I.g.length),m=[],v=0;v<f;v++)m[v]=this.i(v)|I.i(v);return new a(m,this.h|I.h)},n.xor=function(I){for(var f=Math.max(this.g.length,I.g.length),m=[],v=0;v<f;v++)m[v]=this.i(v)^I.i(v);return new a(m,this.h^I.h)};function q(I){for(var f=I.g.length+1,m=[],v=0;v<f;v++)m[v]=I.i(v)<<1|I.i(v-1)>>>31;return new a(m,I.h)}function F(I,f){var m=f>>5;f%=32;for(var v=I.g.length-m,T=[],b=0;b<v;b++)T[b]=0<f?I.i(b+m)>>>f|I.i(b+m+1)<<32-f:I.i(b+m);return new a(T,I.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,Kh=r,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.A,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=h,a.fromString=g,un=a}).apply(typeof jl<"u"?jl:typeof self<"u"?self:typeof window<"u"?window:{});var Ms=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ql(n){let e=0;for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e++;return e}function wn(n,e){for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e(t,n[t])}function od(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $n{constructor(e,t){this.mapKeyFn=e,this.equalsFn=t,this.inner={},this.innerSize=0}get(e){const t=this.mapKeyFn(e),r=this.inner[t];if(r!==void 0){for(const[s,i]of r)if(this.equalsFn(s,e))return i}}has(e){return this.get(e)!==void 0}set(e,t){const r=this.mapKeyFn(e),s=this.inner[r];if(s===void 0)return this.inner[r]=[[e,t]],void this.innerSize++;for(let i=0;i<s.length;i++)if(this.equalsFn(s[i][0],e))return void(s[i]=[e,t]);s.push([e,t]),this.innerSize++}delete(e){const t=this.mapKeyFn(e),r=this.inner[t];if(r===void 0)return!1;for(let s=0;s<r.length;s++)if(this.equalsFn(r[s][0],e))return r.length===1?delete this.inner[t]:r.splice(s,1),this.innerSize--,!0;return!1}forEach(e){wn(this.inner,(t,r)=>{for(const[s,i]of r)e(s,i)})}isEmpty(){return od(this.inner)}size(){return this.innerSize}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mu(n){return function(t,r){if(typeof t!="object"||t===null)return!1;const s=t;for(const i of r)if(i in s&&typeof s[i]=="function")return!0;return!1}(n,["next","error","complete"])}class dr extends Hi{constructor(e,t,r,s){super(e,t,r,s),this.type="firestore",this._queue=new Vu,this._persistenceKey=(s==null?void 0:s.name)||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const e=this._firestoreClient.terminate();this._queue=new Vu(e),this._firestoreClient=void 0,await e}}}function RT(n,e){const t=typeof n=="object"?n:pa(),r=typeof n=="string"?n:fi,s=Si(t,"firestore").getImmediate({identifier:r});if(!s._initialized){const i=ih("firestore");i&&AT(s,...i)}return s}function pf(n){if(n._terminated)throw new B(N.FAILED_PRECONDITION,"The client has already been terminated.");return n._firestoreClient||xT(n),n._firestoreClient}function xT(n){var e,t,r;const s=n._freezeSettings(),i=function(c,u,h,g){return new Qy(c,u,h,g.host,g.ssl,g.experimentalForceLongPolling,g.experimentalAutoDetectLongPolling,df(g.experimentalLongPollingOptions),g.useFetchStreams,g.isUsingEmulator)}(n._databaseId,((e=n._app)===null||e===void 0?void 0:e.options.appId)||"",n._persistenceKey,s);n._componentsProvider||!((t=s.localCache)===null||t===void 0)&&t._offlineComponentProvider&&(!((r=s.localCache)===null||r===void 0)&&r._onlineComponentProvider)&&(n._componentsProvider={_offline:s.localCache._offlineComponentProvider,_online:s.localCache._onlineComponentProvider}),n._firestoreClient=new wT(n._authCredentials,n._appCheckCredentials,n._queue,i,n._componentsProvider&&function(c){const u=c==null?void 0:c._online.build();return{_offline:c==null?void 0:c._offline.build(u),_online:u}}(n._componentsProvider))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ew(n){return n!==void 0}function Bu(n,e,t,r){if(r<e)throw Uu(`Invalid value for '${n}'. Expected ${e} or greater.`);if(r>t)throw Uu(`Invalid value for '${n}'. Expected ${t} or less.`)}function tw(n){const e=encodeURIComponent;let t="?";for(const r in n)if(n.hasOwnProperty(r)){const s=e(r)+"="+e(n[r]);t=t+s+"&"}return t=t.slice(0,-1),t}var Ii;(function(n){n[n.NO_ERROR=0]="NO_ERROR",n[n.NETWORK_ERROR=1]="NETWORK_ERROR",n[n.ABORT=2]="ABORT"})(Ii||(Ii={}));/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lw(n){if(n.length===0)return null;const e=n.lastIndexOf("/");return e===-1?"":n.slice(0,e)}function uw(n){const e=n.lastIndexOf("/",n.length-2);return e===-1?n:n.slice(e+1)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bi{constructor(e,t){this._service=e,t instanceof vt?this._location=t:this._location=vt.makeFromUrl(t,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,t){return new bi(e,t)}get root(){const e=new vt(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return uw(this._location.path)}get storage(){return this._service}get parent(){const e=lw(this._location.path);if(e===null)return null;const t=new vt(this._location.bucket,e);return new bi(this._service,t)}_throwIfRoot(e){if(this._location.path==="")throw JT(e)}}function $u(n,e){const t=e==null?void 0:e[$T];return t==null?null:vt.makeFromBucketSpec(t,n)}function hw(n,e,t,r={}){n.host=`${e}:${t}`;const s=Fn(e);s&&(ua(`https://${n.host}/b`),ha("Storage",!0)),n._isUsingEmulator=!0,n._protocol=s?"https":"http";const{mockUserToken:i}=r;i&&(n._overrideAuthToken=typeof i=="string"?i:ch(i,n.app.options.projectId))}class dw{constructor(e,t,r,s,i,a=!1){this.app=e,this._authProvider=t,this._appCheckProvider=r,this._url=s,this._firebaseVersion=i,this._isUsingEmulator=a,this._bucket=null,this._host=Rf,this._protocol="https",this._appId=null,this._deleted=!1,this._maxOperationRetryTime=qT,this._maxUploadRetryTime=zT,this._requests=new Set,s!=null?this._bucket=vt.makeFromBucketSpec(s,this._host):this._bucket=$u(this._host,this.app.options)}get host(){return this._host}set host(e){this._host=e,this._url!=null?this._bucket=vt.makeFromBucketSpec(this._url,e):this._bucket=$u(e,this.app.options)}get maxUploadRetryTime(){return this._maxUploadRetryTime}set maxUploadRetryTime(e){Bu("time",0,Number.POSITIVE_INFINITY,e),this._maxUploadRetryTime=e}get maxOperationRetryTime(){return this._maxOperationRetryTime}set maxOperationRetryTime(e){Bu("time",0,Number.POSITIVE_INFINITY,e),this._maxOperationRetryTime=e}async _getAuthToken(){if(this._overrideAuthToken)return this._overrideAuthToken;const e=this._authProvider.getImmediate({optional:!0});if(e){const t=await e.getToken();if(t!==null)return t.accessToken}return null}async _getAppCheckToken(){if(mt(this.app)&&this.app.settings.appCheckToken)return this.app.settings.appCheckToken;const e=this._appCheckProvider.getImmediate({optional:!0});return e?(await e.getToken()).token:null}_delete(){return this._deleted||(this._deleted=!0,this._requests.forEach(e=>e.cancel()),this._requests.clear()),Promise.resolve()}_makeStorageReference(e){return new bi(this,e)}_makeRequest(e,t,r,s,i=!0){if(this._deleted)return new YT(xf());{const a=cw(e,this._appId,r,s,t,this._firebaseVersion,i,this._isUsingEmulator);return this._requests.add(a),a.getPromise().then(()=>this._requests.delete(a),()=>this._requests.delete(a)),a}}async makeRequestWithTokens(e,t){const[r,s]=await Promise.all([this._getAuthToken(),this._getAppCheckToken()]);return this._makeRequest(e,t,r,s).getPromise()}}const qu="@firebase/storage",zu="0.13.14";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sf="storage";function fw(n=pa(),e){n=ke(n);const r=Si(n,Sf).getImmediate({identifier:e}),s=ih("storage");return s&&pw(r,...s),r}function pw(n,e,t,r={}){hw(n,e,t,r)}function mw(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),r=n.getProvider("auth-internal"),s=n.getProvider("app-check-internal");return new dw(t,r,s,e,Un)}function gw(){Vn(new fn(Sf,mw,"PUBLIC").setMultipleInstances(!0)),At(qu,zu,""),At(qu,zu,"esm2017")}gw();const _w={apiKey:"AIzaSyATImZKj-kISPLYR68wDnmZPNsnItXdiZ4",authDomain:"sri-raghavendra-mess-billing.firebaseapp.com",projectId:"sri-raghavendra-mess-billing",storageBucket:"sri-raghavendra-mess-billing.firebasestorage.app",messagingSenderId:"225930121586",appId:"1:225930121586:web:5356dc0465009441128deb",measurementId:"G-Z2ZSHZNH5H"},uc=hh(_w),Xi=Ay(uc);h_(Xi,Fh);const Zi=RT(uc);fw(uc);const yw=12,hc="hbs_login_time",vw=async(n,e)=>{const t=await u_(Xi,n,e);return localStorage.setItem(hc,Date.now().toString()),t},Cf=()=>{const n=Number(localStorage.getItem(hc));return n?(Date.now()-n)/(1e3*60*60)<yw:!1},Ew=n=>p_(Xi,n),Tw=async()=>{localStorage.removeItem(hc),await m_(Xi)};let ww={data:""},Iw=n=>{if(typeof window=="object"){let e=(n?n.querySelector("#_goober"):window._goober)||Object.assign(document.createElement("style"),{innerHTML:" ",id:"_goober"});return e.nonce=window.__nonce__,e.parentNode||(n||document.head).appendChild(e),e.firstChild}return n||ww},bw=/(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}\s*)/g,Aw=/\/\*[^]*?\*\/|  +/g,Hu=/\n+/g,sn=(n,e)=>{let t="",r="",s="";for(let i in n){let a=n[i];i[0]=="@"?i[1]=="i"?t=i+" "+a+";":r+=i[1]=="f"?sn(a,i):i+"{"+sn(a,i[1]=="k"?"":e)+"}":typeof a=="object"?r+=sn(a,e?e.replace(/([^,])+/g,c=>i.replace(/([^,]*:\S+\([^)]*\))|([^,])+/g,u=>/&/.test(u)?u.replace(/&/g,c):c?c+" "+u:u)):i):a!=null&&(i=/^--/.test(i)?i:i.replace(/[A-Z]/g,"-$&").toLowerCase(),s+=sn.p?sn.p(i,a):i+":"+a+";")}return t+(e&&s?e+"{"+s+"}":s)+r},Ut={},Pf=n=>{if(typeof n=="object"){let e="";for(let t in n)e+=t+Pf(n[t]);return e}return n},Rw=(n,e,t,r,s)=>{let i=Pf(n),a=Ut[i]||(Ut[i]=(u=>{let h=0,g=11;for(;h<u.length;)g=101*g+u.charCodeAt(h++)>>>0;return"go"+g})(i));if(!Ut[a]){let u=i!==n?n:(h=>{let g,y,E=[{}];for(;g=bw.exec(h.replace(Aw,""));)g[4]?E.shift():g[3]?(y=g[3].replace(Hu," ").trim(),E.unshift(E[0][y]=E[0][y]||{})):E[0][g[1]]=g[2].replace(Hu," ").trim();return E[0]})(n);Ut[a]=sn(s?{["@keyframes "+a]:u}:u,t?"":"."+a)}let c=t&&Ut.g?Ut.g:null;return t&&(Ut.g=Ut[a]),((u,h,g,y)=>{y?h.data=h.data.replace(y,u):h.data.indexOf(u)===-1&&(h.data=g?u+h.data:h.data+u)})(Ut[a],e,r,c),a},xw=(n,e,t)=>n.reduce((r,s,i)=>{let a=e[i];if(a&&a.call){let c=a(t),u=c&&c.props&&c.props.className||/^go/.test(c)&&c;a=u?"."+u:c&&typeof c=="object"?c.props?"":sn(c,""):c===!1?"":c}return r+s+(a??"")},"");function eo(n){let e=this||{},t=n.call?n(e.p):n;return Rw(t.unshift?t.raw?xw(t,[].slice.call(arguments,1),e.p):t.reduce((r,s)=>Object.assign(r,s&&s.call?s(e.p):s),{}):t,Iw(e.target),e.g,e.o,e.k)}let kf,ca,la;eo.bind({g:1});let Gt=eo.bind({k:1});function Sw(n,e,t,r){sn.p=e,kf=n,ca=t,la=r}function An(n,e){let t=this||{};return function(){let r=arguments;function s(i,a){let c=Object.assign({},i),u=c.className||s.className;t.p=Object.assign({theme:ca&&ca()},c),t.o=/ *go\d+/.test(u),c.className=eo.apply(t,r)+(u?" "+u:"");let h=n;return n[0]&&(h=c.as||n,delete c.as),la&&h[0]&&la(c),kf(h,c)}return s}}var Cw=n=>typeof n=="function",Ai=(n,e)=>Cw(n)?n(e):n,Pw=(()=>{let n=0;return()=>(++n).toString()})(),Nf=(()=>{let n;return()=>{if(n===void 0&&typeof window<"u"){let e=matchMedia("(prefers-reduced-motion: reduce)");n=!e||e.matches}return n}})(),kw=20,dc="default",Df=(n,e)=>{let{toastLimit:t}=n.settings;switch(e.type){case 0:return{...n,toasts:[e.toast,...n.toasts].slice(0,t)};case 1:return{...n,toasts:n.toasts.map(a=>a.id===e.toast.id?{...a,...e.toast}:a)};case 2:let{toast:r}=e;return Df(n,{type:n.toasts.find(a=>a.id===r.id)?1:0,toast:r});case 3:let{toastId:s}=e;return{...n,toasts:n.toasts.map(a=>a.id===s||s===void 0?{...a,dismissed:!0,visible:!1}:a)};case 4:return e.toastId===void 0?{...n,toasts:[]}:{...n,toasts:n.toasts.filter(a=>a.id!==e.toastId)};case 5:return{...n,pausedAt:e.time};case 6:let i=e.time-(n.pausedAt||0);return{...n,pausedAt:void 0,toasts:n.toasts.map(a=>({...a,pauseDuration:a.pauseDuration+i}))}}},ni=[],Of={toasts:[],pausedAt:void 0,settings:{toastLimit:kw}},bt={},Vf=(n,e=dc)=>{bt[e]=Df(bt[e]||Of,n),ni.forEach(([t,r])=>{t===e&&r(bt[e])})},Lf=n=>Object.keys(bt).forEach(e=>Vf(n,e)),Nw=n=>Object.keys(bt).find(e=>bt[e].toasts.some(t=>t.id===n)),to=(n=dc)=>e=>{Vf(e,n)},Dw={blank:4e3,error:4e3,success:2e3,loading:1/0,custom:4e3},Ow=(n={},e=dc)=>{let[t,r]=O.useState(bt[e]||Of),s=O.useRef(bt[e]);O.useEffect(()=>(s.current!==bt[e]&&r(bt[e]),ni.push([e,r]),()=>{let a=ni.findIndex(([c])=>c===e);a>-1&&ni.splice(a,1)}),[e]);let i=t.toasts.map(a=>{var c,u,h;return{...n,...n[a.type],...a,removeDelay:a.removeDelay||((c=n[a.type])==null?void 0:c.removeDelay)||(n==null?void 0:n.removeDelay),duration:a.duration||((u=n[a.type])==null?void 0:u.duration)||(n==null?void 0:n.duration)||Dw[a.type],style:{...n.style,...(h=n[a.type])==null?void 0:h.style,...a.style}}});return{...t,toasts:i}},Vw=(n,e="blank",t)=>({createdAt:Date.now(),visible:!0,dismissed:!1,type:e,ariaProps:{role:"status","aria-live":"polite"},message:n,pauseDuration:0,...t,id:(t==null?void 0:t.id)||Pw()}),vs=n=>(e,t)=>{let r=Vw(e,n,t);return to(r.toasterId||Nw(r.id))({type:2,toast:r}),r.id},Fe=(n,e)=>vs("blank")(n,e);Fe.error=vs("error");Fe.success=vs("success");Fe.loading=vs("loading");Fe.custom=vs("custom");Fe.dismiss=(n,e)=>{let t={type:3,toastId:n};e?to(e)(t):Lf(t)};Fe.dismissAll=n=>Fe.dismiss(void 0,n);Fe.remove=(n,e)=>{let t={type:4,toastId:n};e?to(e)(t):Lf(t)};Fe.removeAll=n=>Fe.remove(void 0,n);Fe.promise=(n,e,t)=>{let r=Fe.loading(e.loading,{...t,...t==null?void 0:t.loading});return typeof n=="function"&&(n=n()),n.then(s=>{let i=e.success?Ai(e.success,s):void 0;return i?Fe.success(i,{id:r,...t,...t==null?void 0:t.success}):Fe.dismiss(r),s}).catch(s=>{let i=e.error?Ai(e.error,s):void 0;i?Fe.error(i,{id:r,...t,...t==null?void 0:t.error}):Fe.dismiss(r)}),n};var Lw=1e3,Mw=(n,e="default")=>{let{toasts:t,pausedAt:r}=Ow(n,e),s=O.useRef(new Map).current,i=O.useCallback((y,E=Lw)=>{if(s.has(y))return;let R=setTimeout(()=>{s.delete(y),a({type:4,toastId:y})},E);s.set(y,R)},[]);O.useEffect(()=>{if(r)return;let y=Date.now(),E=t.map(R=>{if(R.duration===1/0)return;let x=(R.duration||0)+R.pauseDuration-(y-R.createdAt);if(x<0){R.visible&&Fe.dismiss(R.id);return}return setTimeout(()=>Fe.dismiss(R.id,e),x)});return()=>{E.forEach(R=>R&&clearTimeout(R))}},[t,r,e]);let a=O.useCallback(to(e),[e]),c=O.useCallback(()=>{a({type:5,time:Date.now()})},[a]),u=O.useCallback((y,E)=>{a({type:1,toast:{id:y,height:E}})},[a]),h=O.useCallback(()=>{r&&a({type:6,time:Date.now()})},[r,a]),g=O.useCallback((y,E)=>{let{reverseOrder:R=!1,gutter:x=8,defaultPosition:A}=E||{},S=t.filter(k=>(k.position||A)===(y.position||A)&&k.height),V=S.findIndex(k=>k.id===y.id),M=S.filter((k,L)=>L<V&&k.visible).length;return S.filter(k=>k.visible).slice(...R?[M+1]:[0,M]).reduce((k,L)=>k+(L.height||0)+x,0)},[t]);return O.useEffect(()=>{t.forEach(y=>{if(y.dismissed)i(y.id,y.removeDelay);else{let E=s.get(y.id);E&&(clearTimeout(E),s.delete(y.id))}})},[t,i]),{toasts:t,handlers:{updateHeight:u,startPause:c,endPause:h,calculateOffset:g}}},jw=Gt`
from {
...
to {
  ...
  animation: ${Qw} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,Yw=({toast:n})=>{let{icon:e,type:t,iconTheme:r}=n;return e!==void 0?typeof e=="string"?O.createElement(Jw,null,e):e:t==="blank"?null:O.createElement(Kw,null,O.createElement(qw,{...r}),t!=="loading"&&O.createElement(Gw,null,t==="error"?O.createElement(Bw,{...r}):O.createElement(Ww,{...r})))},Xw=n=>`
0% {transform: translate3d(0,${n*-200}%,0) scale(.6); opacity:.5;}
100% {transform: translate3d(0,0,0) scale(1); opacity:1;}
`,Zw=n=>`
0% {transform: translate3d(0,0,-1px) scale(1); opacity:1;}
100% {transform: translate3d(0,${n*-150}%,-1px) scale(.6); opacity:0;}
`,eI="0%{opacity:0;} 100%{opacity:1;}",tI="0%{opacity:1;} 100%{opacity:0;}",nI=An("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
...
`:"\r"}}function S(f){return f.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function V(f){var m=(f=f||{}).delimiter,v=f.newline,T=f.comments,b=f.step,w=f.preview,te=f.fastMode,we=null,Ne=!1,Q=f.quoteChar==null?'"':f.quoteChar,de=Q;if(f.escapeChar!==void 0&&(de=f.escapeChar),(typeof m!="string"||-1<h.BAD_DELIMITERS.indexOf(m))&&(m=","),T===m)throw new Error("Comment character same as delimiter");T===!0?T="#":(typeof T!="string"||-1<h.BAD_DELIMITERS.indexOf(T))&&(T=!1),v!==`
`&&v!=="\r"&&v!==`\r
`&&(v=`
`);var H=0,Se=!1;this.parse=function(Z,Y,U){if(typeof Z!="string")throw new Error("Input must be a string");var Ce=Z.length,ye=m.length,je=v.length,$e=T.length,se=I(b),le=[],ge=[],W=[],ve=H=0;if(!Z)return De();if(te||te!==!1&&Z.indexOf(Q)===-1){for(var Ae=Z.split(v),he=0;he<Ae.length;he++){if(W=Ae[he],H+=W.length,he!==Ae.length-1)H+=v.length;else if(U)return De();if(!T||W.substring(0,$e)!==T){if(se){if(le=[],ht(W.split(m)),ct(),Se)return De()}else ht(W.split(m));if(w&&w<=he)return le=le.slice(0,w),De(!0)}}return De()}for(var fe=Z.indexOf(m,H),re=Z.indexOf(v,H),at=new RegExp(S(de)+S(Q),"g"),ee=Z.indexOf(Q,H);;)if(Z[H]===Q)for(ee=H,H++;;){if((ee=Z.indexOf(Q,ee+1))===-1)return U||ge.push({type:"Quotes",code:"MissingQuotes",message:"Quoted field unterminated",row:le.length,index:H}),dt();if(ee===Ce-1)return dt(Z.substring(H,ee).replace(at,Q));if(Q===de&&Z[ee+1]===de)ee++;else if(Q===de||ee===0||Z[ee-1]!==de){fe!==-1&&fe<ee+1&&(fe=Z.indexOf(m,ee+1));var Ee=Lt((re=re!==-1&&re<ee+1?Z.indexOf(v,ee+1):re)===-1?fe:Math.min(fe,re));if(Z.substr(ee+1+Ee,ye)===m){W.push(Z.substring(H,ee).replace(at,Q)),Z[H=ee+1+Ee+ye]!==Q&&(ee=Z.indexOf(Q,H)),fe=Z.indexOf(m,H),re=Z.indexOf(v,H);break}if(Ee=Lt(re),Z.substring(ee+1+Ee,ee+1+Ee+je)===v){if(W.push(Z.substring(H,ee).replace(at,Q)),Mt(ee+1+Ee+je),fe=Z.indexOf(m,H),ee=Z.indexOf(Q,H),se&&(ct(),Se))return De();if(w&&le.length>=w)return De(!0);break}ge.push({type:"Quotes",code:"InvalidQuotes",message:"Trailing quote on quoted field is malformed",row:le.length,index:H}),ee++}}else if(T&&W.length===0&&Z.substring(H,H+$e)===T){if(re===-1)return De();H=re+je,re=Z.indexOf(v,H),fe=Z.indexOf(m,H)}else if(fe!==-1&&(fe<re||re===-1))W.push(Z.substring(H,fe)),H=fe+ye,fe=Z.indexOf(m,H);else{if(re===-1)break;if(W.push(Z.substring(H,re)),Mt(re+je),se&&(ct(),Se))return De();if(w&&le.length>=w)return De(!0)}return dt();function ht(ae){le.push(ae),ve=H}function Lt(ae){var pe=0;return pe=ae!==-1&&(ae=Z.substring(ee+1,ae))&&ae.trim()===""?ae.length:pe}function dt(ae){return U||(ae===void 0&&(ae=Z.substring(H)),W.push(ae),H=Ce,ht(W),se&&ct()),De()}function Mt(ae){H=ae,ht(W),W=[],re=Z.indexOf(v,H)}function De(ae){if(f.header&&!Y&&le.length&&!Ne){var pe=le[0],rt=Object.create(null),zn=new Set(pe);let Tr=!1;for(let Kt=0;Kt<pe.length;Kt++){let Qe=pe[Kt];if(rt[Qe=I(f.transformHeader)?f.transformHeader(Qe,Kt):Qe]){let Qt,wr=rt[Qe];for(;Qt=Qe+"_"+wr,wr++,zn.has(Qt););zn.add(Qt),pe[Kt]=Qt,rt[Qe]++,Tr=!0,(we=we===null?{}:we)[Qt]=Qe}else rt[Qe]=1,pe[Kt]=Qe;zn.add(Qe)}Tr&&console.warn("Duplicate headers found and renamed."),Ne=!0}return{data:le,errors:ge,meta:{delimiter:m,linebreak:v,aborted:Se,truncated:!!ae,cursor:ve+(Y||0),renamedHeaders:we}}}function ct(){b(De()),le=[],ge=[]}},this.abort=function(){Se=!0},this.getCharIndex=function(){return H}}function M(f){var m=f.data,v=c[m.workerId],T=!1;if(m.error)v.userError(m.error,m.file);else if(m.results&&m.results.data){var b={abort:function(){T=!0,k(m.workerId,{data:[],errors:[],meta:{aborted:!0}})},pause:L,resume:L};if(I(v.userStep)){for(var w=0;w<m.results.data.length&&(v.userStep({data:m.results.data[w],errors:m.results.errors,meta:m.results.meta},b),!T);w++);delete m.results}else I(v.userChunk)&&(v.userChunk(m.results,b,m.file),delete m.results)}m.finished&&!T&&k(m.workerId,m.results)}function k(f,m){var v=c[f];I(v.userComplete)&&v.userComplete(m),v.terminate(),delete c[f]}function L(){throw new Error("Not implemented.")}function q(f){if(typeof f!="object"||f===null)return f;var m,v=Array.isArray(f)?[]:{};for(m in f)v[m]=q(f[m]);return v}function F(f,m){return function(){f.apply(m,arguments)}}function I(f){return typeof f=="function"}return h.parse=function(f,m){var v=(m=m||{}).dynamicTyping||!1;if(I(v)&&(m.dynamicTypingFunction=v,v={}),m.dynamicTyping=v,m.transform=!!I(m.transform)&&m.transform,!m.worker||!h.WORKERS_SUPPORTED)return v=null,h.NODE_STREAM_INPUT,typeof f=="string"?(f=(T=>T.charCodeAt(0)!==65279?T:T.slice(1))(f),v=new(m.download?y:R)(m)):f.readable===!0&&I(f.read)&&I(f.on)?v=new x(m):(r.File&&f instanceof File||f instanceof Object)&&(v=new E(m)),v.stream(f);(v=(()=>{var T;return!!h.WORKERS_SUPPORTED&&(T=(()=>{var b=r.URL||r.webkitURL||null,w=t.toString();return h.BLOB_URL||(h.BLOB_URL=b.createObjectURL(new Blob(["var global = (function() { if (typeof self !== 'undefined') { return self; } if (typeof window !== 'undefined') { return window; } if (typeof global !== 'undefined') { return global; } return {}; })(); global.IS_PAPA_WORKER=true; ","(",w,")();"],{type:"text/javascript"})))})(),(T=new r.Worker(T)).onmessage=M,T.id=u++,c[T.id]=T)})()).userStep=m.step,v.userChunk=m.chunk,v.userComplete=m.complete,v.userError=m.error,m.step=I(m.step),m.chunk=I(m.chunk),m.complete=I(m.complete),m.error=I(m.error),delete m.worker,v.postMessage({input:f,config:m,workerId:v.id})},h.unparse=function(f,m){var v=!1,T=!0,b=",",w=`\r
`,te='"',we=te+te,Ne=!1,Q=null,de=!1,H=((()=>{if(typeof m=="object"){if(typeof m.delimiter!="string"||h.BAD_DELIMITERS.filter(function(Y){return m.delimiter.indexOf(Y)!==-1}).length||(b=m.delimiter),typeof m.quotes!="boolean"&&typeof m.quotes!="function"&&!Array.isArray(m.quotes)||(v=m.quotes),typeof m.skipEmptyLines!="boolean"&&typeof m.skipEmptyLines!="string"||(Ne=m.skipEmptyLines),typeof m.newline=="string"&&(w=m.newline),typeof m.quoteChar=="string"&&(te=m.quoteChar),typeof m.header=="boolean"&&(T=m.header),Array.isArray(m.columns)){if(m.columns.length===0)throw new Error("Option columns is empty");Q=m.columns}m.escapeChar!==void 0&&(we=m.escapeChar+te),m.escapeFormulae instanceof RegExp?de=m.escapeFormulae:typeof m.escapeFormulae=="boolean"&&m.escapeFormulae&&(de=/^[=+\-@\t\r].*$/)}})(),new RegExp(S(te),"g"));if(typeof f=="string"&&(f=JSON.parse(f)),Array.isArray(f)){if(!f.length||Array.isArray(f[0]))return Se(null,f,Ne);if(typeof f[0]=="object")return Se(Q||Object.keys(f[0]),f,Ne)}else if(typeof f=="object")return typeof f.data=="string"&&(f.data=JSON.parse(f.data)),Array.isArray(f.data)&&(f.fields||(f.fields=f.meta&&f.meta.fields||Q),f.fields||(f.fields=Array.isArray(f.data[0])?f.fields:typeof f.data[0]=="object"?Object.keys(f.data[0]):[]),Array.isArray(f.data[0])||typeof f.data[0]=="object"||(f.data=[f.data])),Se(f.fields||[],f.data||[],Ne);throw new Error("Unable to serialize unrecognized input");function Se(Y,U,Ce){var ye="",je=(typeof Y=="string"&&(Y=JSON.parse(Y)),typeof U=="string"&&(U=JSON.parse(U)),Array.isArray(Y)&&0<Y.length),$e=!Array.isArray(U[0]);if(je&&T){for(var se=0;se<Y.length;se++)0<se&&(ye+=b),ye+=Z(Y[se],se);0<U.length&&(ye+=w)}for(var le=0;le<U.length;le++){var ge=(je?Y:U[le]).length,W=!1,ve=je?Object.keys(U[le]).length===0:U[le].length===0;if(Ce&&!je&&(W=Ce==="greedy"?U[le].join("").trim()==="":U[le].length===1&&U[le][0].length===0),Ce==="greedy"&&je){for(var Ae=[],he=0;he<ge;he++){var fe=$e?Y[he]:he;Ae.push(U[le][fe])}W=Ae.join("").trim()===""}if(!W){for(var re=0;re<ge;re++){0<re&&!ve&&(ye+=b);var at=je&&$e?Y[re]:re;ye+=Z(U[le][at],re)}le<U.length-1&&(!Ce||0<ge&&!ve)&&(ye+=w)}}return ye}function Z(Y,U){var Ce,ye;return Y==null?"":Y.constructor===Date?JSON.stringify(Y).slice(1,25):(ye=!1,de&&typeof Y=="string"&&de.test(Y)&&(Y="'"+Y,ye=!0),Ce=Y.toString().replace(H,we),(ye=ye||v===!0||typeof v=="function"&&v(Y,U)||Array.isArray(v)&&v[U]||((je,$e)=>{for(var se=0;se<$e.length;se++)if(-1<je.indexOf($e[se]))return!0;return!1})(Ce,h.BAD_DELIMITERS)||-1<Ce.indexOf(b)||Ce.charAt(0)===" "||Ce.charAt(Ce.length-1)===" ")?te+Ce+te:Ce)}},h.RECORD_SEP="",h.UNIT_SEP="",h.BYTE_ORDER_MARK="\uFEFF",h.BAD_DELIMITERS=["\r",`
`,'"',h.BYTE_ORDER_MARK],h.WORKERS_SUPPORTED=!i&&!!r.Worker,h.NODE_STREAM_INPUT=1,h.LocalChunkSize=10485760,h.RemoteChunkSize=5242880,h.DefaultDelimiter=",",h.Parser=V,h.ParserHandle=A,h.NetworkStreamer=y,h.FileStreamer=E,h.StringStreamer=R,h.ReadableStreamStreamer=x,r.jQuery&&((s=r.jQuery).fn.parse=function(f){var m=f.config||{},v=[];return this.each(function(w){if(!(s(this).prop("tagName").toUpperCase()==="INPUT"&&s(this).attr("type").toLowerCase()==="file"&&r.FileReader)||!this.files||this.files.length===0)return!0;for(var te=0;te<this.files.length;te++)v.push({file:this.files[te],inputElem:this,instanceConfig:s.extend({},m)})}),T(),this;function T(){if(v.length===0)I(f.complete)&&f.complete();else{var w,te,we,Ne,Q=v[0];if(I(f.before)){var de=f.before(Q.file,Q.inputElem);if(typeof de=="object"){if(de.action==="abort")return w="AbortError",te=Q.file,we=Q.inputElem,Ne=de.reason,void(I(f.error)&&f.error({name:w},te,we,Ne));if(de.action==="skip")return void b();typeof de.config=="object"&&(Q.instanceConfig=s.extend(Q.instanceConfig,de.config))}else if(de==="skip")return void b()}var H=Q.instanceConfig.complete;Q.instanceConfig.complete=function(Se){I(H)&&H(Se,Q.file,Q.inputElem),b()},h.parse(Q.file,Q.instanceConfig)}}function b(){v.splice(0,1),T()}}),a&&(r.onmessage=function(f){f=f.data,h.WORKER_ID===void 0&&f&&(h.WORKER_ID=f.workerId),typeof f.input=="string"?r.postMessage({workerId:h.WORKER_ID,results:h.parse(f.input,f.config),finished:!0}):(r.File&&f.input instanceof File||f.input instanceof Object)&&(f=h.parse(f.input,f.config))&&r.postMessage({workerId:h.WORKER_ID,results:f,finished:!0})}),(y.prototype=Object.create(g.prototype)).constructor=y,(E.prototype=Object.create(g.prototype)).constructor=E,(R.prototype=Object.create(R.prototype)).constructor=R,(x.prototype=Object.create(g.prototype)).constructor=x,h})})(Wf);var PI=Wf.exports;const kI=Ip(PI),Oo=(n,e)=>{if(!n||n.length===0){alert("No data to export");return}const t=kI.unparse(n,{skipEmptyLines:!0}),r=new Blob([t],{type:"text/csv;charset=utf-8;"}),s=URL.createObjectURL(r),i=document.createElement("a");i.href=s,i.download=e||"export.csv",i.click(),URL.revokeObjectURL(s)},NI=["Section","Date","Payment","Total","Customer","Items","Title","Amount","Note","TotalIncome","TotalExpense","ProfitOrLoss"],Gu={morning:0,afternoon:1,evening:2,order:3},DI=(n=[])=>{const e={morning:[],afternoon:[],evening:[],order:[]};return n.forEach(t=>{(e[t.sessionType]||e.morning).push({section:t.sessionType,date:He(t.createdDate),payment:t.paymentMode,total:t.billTotal,customer:t.customerNameOrToken,items:(t.items||[]).map(s=>s.itemName).join("; ")})}),e},ir=(n=0)=>Math.round((n||0)*100)/100,ft=(n=0)=>ir(n).toFixed(2),Ku=(n=[])=>ir(n.reduce((e,t)=>e+(t.billTotal||0),0)),Qu=(n=[])=>ir(n.reduce((e,t)=>e+(t.amount||0),0)),pt=(n={})=>[n.section||"",n.date||"",n.payment||"",n.total??"",n.customer||"",n.items||"",n.title||"",n.amount??"",n.note||"",n.totalIncome??"",n.totalExpense??"",n.profitOrLoss??""],Ju=n=>{if(!n.createdDate)return 0;const e=n.createdTime?`${n.createdDate} ${n.createdTime}`:n.createdDate,t=Date.parse(e);return Number.isNaN(t)?Date.parse(n.createdDate)||0:t},OI=(n=[])=>[...n].sort((e,t)=>{const r=Ju(e),s=Ju(t);if(s!==r)return s-r;const i=Gu[e.sessionType]??99,a=Gu[t.sessionType]??99;return i-a});function Gf({bills:n=[],expenses:e=[],today:t,history:r=[],orders:s=[]}){const[i,a]=O.useState({title:"",type:"",data:{}}),c=()=>pt({}),u=()=>{const k=DI(n),L=Ku(n),q=Qu(e),F=[];return F.push(pt({section:"--- Morning ---"})),k.morning.forEach(I=>F.push(pt(I))),F.push(c()),F.push(pt({section:"--- Afternoon ---"})),k.afternoon.forEach(I=>F.push(pt(I))),F.push(c()),F.push(pt({section:"--- Evening ---"})),k.evening.forEach(I=>F.push(pt(I))),F.push(c()),F.push(pt({section:"--- Orders ---"})),k.order.forEach(I=>F.push(pt(I))),F.push(c()),F.push(pt({section:"--- Expenses ---"})),e.forEach(I=>F.push(pt({section:"expense",date:He(I.expenseDate),title:I.expenseTitle,amount:I.amount,note:I.note}))),F.push(c()),F.push(pt({section:"Totals",totalIncome:ft(L),totalExpense:ft(q),profitOrLoss:ft(L-q)})),F},h=()=>{const k=OI(n),L=Ku(n),q=Qu(e),F={incomeTotal:ir(L),expenseTotal:ir(q),profit:ir(L-q)};return{bills:k,expenses:e,summary:F}},g=()=>r.map(k=>[He(k.date),ft(k.totalSales),ft(k.totalExpense),ft(k.netProfit)]),y=()=>s.map(k=>[k.sessionType,He(k.createdDate),k.paymentMode,k.billTotal,k.customerNameOrToken,(k.items||[]).map(L=>L.itemName).join("; ")]),E=()=>{if(!t)return alert("No date");Oo([NI,c(),...u()],`today-bills-expenses-${t}.csv`)},R=()=>{if(!t)return alert("No date");a({title:`Bills + Expenses (${He(t)})`,type:"today",data:h()})},x=()=>{Oo([["Date","Total Sales","Expense","Profit"],[""],...g()],"history.csv")},A=()=>{a({title:"History",type:"history",data:{header:["Date","Total Sales","Expense","Profit"],rows:g()}})},S=()=>{if(!s.length)return alert("No orders");Oo([["Session","Date","Payment","Total","Customer","Items"],[""],...y()],`orders-${t||"all"}.csv`)},V=()=>{if(!s.length)return alert("No orders");a({title:"Orders",type:"orders",data:{header:["Session","Date","Payment","Total","Customer","Items"],rows:y()}})},M=()=>{var v;if(i.type!=="today"||!((v=i.data)!=null&&v.bills))return;const{bills:k,expenses:L,summary:q}=i.data,F=k.map(T=>`
      <tr>
